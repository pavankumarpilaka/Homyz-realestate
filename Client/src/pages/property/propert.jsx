  ...
  const {pathname}=useLocation()
    ...
    const {mutate:cancelBooking,isLoading:cancelling}=useMutation({
      ...
      onSuccess:()=>{
        ...
        toast.success("bookking cancelled sucessfully...")
      }
    })
    if(isLoading){
      return(
          ...
          <div className="like">
           ...
           <div className="flexCenter property-details">
            <div className="flexColStart left">
              <div className="fleColStart head">
                <span className='primaryText'>{data.title}</span><br/>
              ...
              (
               ...
               <span>Visit Already booked for date {bookings?.filter((booking)=>booking?.id==id)[0].date}</span>
               </>
               
              ):(
              <button className='button' onClick={() => {
              const valid = validateLogin();
                console.log("Is login valid?", valid);
                if (valid) {
